...
# --- 2. ESTILOS CSS (EL BLINDAJE PERFECTO PARA INSTAGRAM) ---
st.markdown("""
    <style>
        /* === 0. FORZADO DE MODO CLARO GLOBAL === */
        ...
        /* Forzar textos generales a negro */
        .stApp, p, label, h2, h3, h4, h5, h6, div, span, li {
            color: #000000 !important;
        }
        
        /* Título principal blanco (Header) */
        h1 { color: #FFFFFF !important; }
        
        /* Encabezado Azul */
        header[data-testid="stHeader"] { background-color: #003399 !important; }

        /* === 1. ARREGLO DE INPUTS Y SELECTORES (CATEGORÍA Y FECHA) === */
        ...
        /* INPUTS (Texto y Fecha) - Texto Negro Forzado */
        input {
            color: #000000 !important;
        ...
        /* TEXTO DENTRO DEL SELECTOR (TEER) */
        div[data-baseweb="select"] span {
            color: #000000 !important;
            -webkit-text-fill-color: #000000 !important;
        }
        
        /* ICONOS (Flechita y Calendario) */
        div[data-baseweb="select"] svg, div[data-baseweb="input"] svg {
            fill: #000000 !important;
        }

        /* === 2. MENÚ DESPLEGABLE (LISTA ABIERTA) === */
        ...
        div.stButton > button[kind="secondary"] * { 
            color: #003399 !important; -webkit-text-fill-color: #003399 !important; 
        }
        ...
        /* Cajas de información (Azules/Amarillas) */
        ...
        /* Forzar texto negro dentro de las cajas de info */
        .info-box *, .help-box *, div.stAlert * {
            color: #000000 !important;
            -webkit-text-fill-color: #000000 !important;
        }
...
with main_tab_calc:
    ...
    if st.session_state.step == 1:
        ...
        if "bec" not in st.session_state.current_loc:
             ...
             # CARRUSEL CIUDAD (DESPLEGABLE RESTAURADO A SELECTBOX CON FIX CSS)
             st.divider()
             ...
             # FECHA CALENDARIO (RESTAURADO CON FIX CSS)
             st.divider()
    ...
    # --- PASO 2: TRABAJO ---
        ...
        # RESTAURADO A SELECTBOX CON TEXTO LARGO
        current_idx = 0
        ...
        st.session_state.edu = st.selectbox(lang['edu_label'], ["PhD", "Master", "Bachelor", "College (3y)", "Diploma (1-2y)", "Secondary"], index=2, key="edu_input")

...
# --- 2. ESTILOS CSS (BLINDAJE ANTI-INSTAGRAM + DISEÑO PRO) ---
st.markdown("""
    <style>
        /* === 0. FORZADO GLOBAL === */
        ...
        /* === 1. INPUTS Y SELECTORES (FONDO BLANCO / TEXTO NEGRO) === */
...
# COLUMNAS PARA LOS BOTONES DE MONETIZACIÓN (MOVIMOS ESTO AQUÍ)

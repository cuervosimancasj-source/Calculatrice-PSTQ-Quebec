...
# --- 2. ESTILOS CSS (BLINDAJE TOTAL PARA INSTAGRAM/MÓVIL) ---
st.markdown("""
    <style>
        /* === 0. FORZADO GLOBAL === */
        :root {
        ...
        /* === 1. INPUTS Y SELECTORES (CRÍTICO) === */
        /* Forzar fondo blanco en los contenedores de input */
        div[data-baseweb="input"], div[data-baseweb="base-input"], div[data-baseweb="select"] > div {
            background-color: #FFFFFF !important;
            border: 1px solid #cccccc !important;
        }

        /* Forzar texto negro dentro de los inputs */
        input, .st-bf, .st-bg, .st-bh {
            color: #000000 !important;
        ...
        /* Texto del elemento seleccionado en dropdown */
...
def cycle_language():
    ...
    # Resetear TEER al cambiar idioma para actualizar texto
...
t = {
    ...
    'es': {
        ...
        'fam_qc_help': "Padres, hijos, cónyuge, hermanos, abuelos (Residente o Ciudadano).",
...
with main_tab_calc:
    ...
    if st.session_state.show_results:
        ...
        # Lógica TEER (Detecta texto parcial para soportar idiomas)
        ...
        if st.button("🔄 Recalculer / Reiniciar"): reset_calc(); st.rerun()

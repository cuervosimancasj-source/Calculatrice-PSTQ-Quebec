...
# --- 2. ESTILOS CSS (DISEÑO FINAL BLINDADO) ---
st.markdown("""
    <style>
        /* === 0. BASE MODO CLARO === */
        ...
        .stepper-box {
            ...
            font-weight: bold;
            font-size: 1.1rem;
            min-height: 80px; /* Altura para texto largo TEER */
            display: flex;
            align-items: center;
...
t = {
    'fr': {
        ...
        'fam_qc_help': "**Famille :** Avez-vous de la famille proche (Parent, enfant, conjoint, frère/sœur) Résident ou Citoyen ?",
    ...
    'es': {
        ...
        'job_title': "Trabajo actual", 'job_place': "Ej: Ingeniero, Soldador...",
        ...
        'vjo_label': "¿Tienes Oferta Validada?", 'vjo_opts': ["No", "Sí, Gran Montreal", "Sí, Fuera de Montreal"],
        'dip_qc_label': "¿Diploma de Quebec?", 'dip_qc_help': "ℹ️ **Diploma:** AEC, DEC, Bachelor...",
        'fam_qc_label': "¿Familia en Quebec?", 'fam_qc_help': "ℹ️ **Familia:** Residentes o Ciudadanos.",
        ...
        'g_step1': "1. Autoevaluación", 'g_desc1': "Fortalezas.",
        'g_step2': "2. Francés", 'g_desc2': "Apunta a B2.",
        'g_step3': "3. Arrima", 'g_desc3': "Perfil.",
    ...
    'en': {
        ...
        'tab1_sub': "Personal profile.", 'tab2_sub': "Experience.", 'tab3_sub': "Language.", 'tab4_sub': "Local factors.",
        ...
        'job_title': "Current Job", 'job_place': "Ex: Welder...",
...
with main_tabs[0]:
    ...
    if st.session_state.step == 1:
        ...
        if st.session_state.spouse:
            ...
            with c_sp1: st.session_state.sp_age = st.number_input(lang['sp_age'], 18, 65, 30)
            with c_sp2: 
    ...
    # PASO 2
        ...
        if st.session_state.job_search_term:
            ...
            if result:
                ...
                # Actualizar carrusel si se encuentra (Mapeo simple)
                # (Aquí podrías agregar lógica para auto-seleccionar el TEER)
            else:

...
# --- 2. ESTILOS CSS (DISEÑO CARRUSEL + ANTI-DARK MODE) ---
st.markdown("""
    <style>
        ...
        .stepper-box {
            ...
            font-weight: bold;
            font-size: 1rem;
            min-height: 60px; /* Altura fija para que no salte */
            display: flex;
            align-items: center;
        ...
        div[data-testid="column"] button {
            ...
            height: 60px !important; /* Misma altura que la caja */
...
# --- 3. FUNCIÓN CARRUSEL (LA LÓGICA QUE TE GUSTABA) ---
def render_carousel(label, options, key_name):
    ...
    # Columnas: Botón (1) - Texto (4) - Botón (1)
...
t = {
    'fr': {
        ...
        'disclaimer_text': "Ce logiciel est un projet indépendant. Nous ne sommes PAS avocats ni consultants. Usage informatif seulement.",
        ...
        'oev_info': "ℹ️ **OEV :** Offre validée par le MIFI (EIMT).",
        'vjo_label': "Avez-vous une Offre Validée ?",
        'vjo_opts': ["Non", "Oui, Grand Montréal", "Oui, Région"],
        'dip_qc_label': "Diplôme du Québec ?", 
        'dip_qc_help': "ℹ️ **Diplôme :** Avez-vous obtenu un diplôme au Québec ?",
        'fam_qc_label': "Famille au Québec ?", 
        'fam_qc_help': "ℹ️ **Famille :** Résident ou Citoyen (Parent, enfant...).",
    ...
    'es': {
        ...
        'disclaimer_text': "No somos abogados ni asesores. Proyecto independiente.",
        ...
        'lang_info': "**Requisitos:** Nivel 7 (B2) | Pareja Nivel 4 (A2)",
        ...
        'dip_qc_help': "ℹ️ **Diploma:** ¿Tienes un título (AEC, DEC, Bachelor) de Quebec?",
        'fam_qc_label': "¿Familia en Quebec?",
        'fam_qc_help': "ℹ️ **Familia:** ¿Padres, hijos, hermanos Residentes?",
...
with main_tabs[0]:
    ...
    if st.session_state.step == 1:
        ...
        if "bec" not in sel_loc and "Quebec" not in sel_loc:
             ...
             st.session_state.arrival_text = st.text_input("Date", placeholder="YYYY-MM-DD", label_visibility="collapsed")
        ...
        if st.session_state.spouse:
            ...
            with c_se: 
                # CARRUSEL EDU PAREJA
                sel_sp_edu = render_carousel(l['sp_header'], l['sp_edu_opts'], 'sp_edu')
    ...
    # PASO 2
        ...
        # CARRUSEL TEER
        sel_teer = render_carousel(l['teer_label'], l['teer_opts'], 'teer')
        st.session_state.teer_sel = sel_teer
        
        st.divider()
        # CARRUSEL EDU
        sel_edu = render_carousel(l['edu_label'], l['edu_opts'], 'edu')
    ...
    # PASO 4
        ...
        st.info(l['oev_info'])
        sel_vjo = render_carousel(l['vjo_label'], l['vjo_opts'], 'vjo')
        st.session_state.vjo = sel_vjo
        
        st.divider()
        st.info(l['dip_qc_help'])
        sel_stud = render_carousel(l['dip_qc_label'], l['yes_no'], 'q_stud')
        st.session_state.q_stud_val = sel_stud
        
        st.divider()
        st.info(l['fam_qc_help'])
        sel_fam = render_carousel(l['fam_qc_label'], l['yes_no'], 'q_fam')
    ...
    c1, c2 = st.columns(2)
    with c1: st.link_button(l['coffee'], "https://www.buymeacoffee.com/CalculatricePSTQQuebec")
    with c2: st.link_button(l['courses'], "https://www.TU_ENLACE_DE_AFILIADO.com")

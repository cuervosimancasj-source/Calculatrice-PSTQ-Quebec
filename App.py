...
# --- 2. ESTILOS CSS (ESTABLE Y BLINDADO) ---
st.markdown("""
    <style>
        ...
        /* === 2. INPUTS Y SELECTORES (BLINDAJE PARA INSTAGRAM) === */
        ...
        /* Checkbox/Radio Text */
        label[data-baseweb="checkbox"], label[data-baseweb="radio"] { color: #000000 !important; }
...
default_vars = {
    ...
    'teer_sel': 'TEER 0, 1: Université / Gestion / Ingénierie', 'edu': 'Secondary', 
    'dest_city': '-'
}
...
def cycle_language():
    ...
    # Resetear valores dependientes de idioma
...
t = {
    'fr': {
        ...
        'dip_qc_help': "**Diplôme :** Avez-vous obtenu un diplôme (AEC, DEC, Bac, etc.) d'un établissement au Québec ?",
    ...
    if st.session_state.step == 1:
        ...
        if "bec" not in st.session_state.current_loc:
             ...
             with c_dest:
                 ...
                 st.session_state.dest_city = st.selectbox(lang['city_label'], lang['city_opts'], index=lang['city_opts'].index(curr_city))
             with c_date:

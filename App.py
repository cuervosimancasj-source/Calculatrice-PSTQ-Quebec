...
# --- 2. ESTILOS CSS (HEADER CON BANDERAS + ANTI-DARK MODE) ---
st.markdown("""
    <style>
        /* === 0. FORZADO GLOBAL === */
        ...
        /* === 1. NUEVO HEADER (BANDERAS EN ESQUINAS) === */
        .pro-header {
...
t = {
    'fr': {
        ...
        'brand': "Calculatrice PSTQ", # Texto central header
    ...
    'en': {
        ...
        'city_opts': ["-", "Montréal", "Québec (Ville)", "Laval", "Gatineau", "Sherbrooke", "Trois-Rivières", "Saguenay", "Other"],
